...
public class ProgrammaticDatasourceConfigurer implements TenantConnectionResolver {
    ...
    public ConnectionProvider resolve(String tenantId) {
        var jdbcUrl = String.format("jdbc:sqlserver://localhost:1433;databaseName=master;encrypt=false", tenantId, UUID.randomUUID());
        ...
        try {
            ...
            flywayDataSourceConfiguration
                    ...
                    .credential(new SimplePassword("Senha@12345"));
